...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boss.setHealth(700);
        boss.setDamage(40);
        boss.setProtection("anti");
        System.out.println("Здоровье босса " + boss.getHealth() + " " + " Урон босса:"
                + boss.getDamage() + "" + " Тип защиты босса:" + boss.getProtection());
        System.out.println(createHeroes());
    }
    public static String createHeroes() {
        Hero hero1 = new Hero(150, 30, "SuperHit");
        Hero hero2 = new Hero(140, 35, "SuperKick");
        Hero hero3 = new Hero(155, 40);
